...
if( ! function_exists( 'mfn_fonts_selected' ) )
{
	function mfn_fonts_selected(){
		...
		$fonts['content'] 		= mfn_opts_get( 'font-content', 		'BYekan' );
		$fonts['menu'] 			= mfn_opts_get( 'font-menu', 			'BYekan' );
		$fonts['title'] 		= mfn_opts_get( 'font-title', 			'BYekan' );
		$fonts['headings'] 		= mfn_opts_get( 'font-headings', 		'BYekan' );
		$fonts['headingsSmall'] = mfn_opts_get( 'font-headings-small', 	'BYekan' );
		$fonts['blockquote'] 	= mfn_opts_get( 'font-blockquote', 		'BYekan' );
		$fonts['decorative'] 	= mfn_opts_get( 'font-decorative', 		'BYekan' );
